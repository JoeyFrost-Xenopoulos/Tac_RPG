...
function Resources.load()
    ...
    Resources.backgroundPlayer = love.graphics.newImage("assets/ui/menu/stats_menu.png")
    Resources.backgroundEnemy = love.graphics.newImage("assets/ui/menu/stats_menu.png")
