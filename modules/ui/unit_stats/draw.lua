...
function Draw.drawAvatar(unit, panelX, panelY, padding)
    if unit.avatar then
...
function Draw.drawNameAndType(unit, panelX, panelY, padding, nameY)
    if Resources.font then
        love.graphics.setFont(Resources.font)
        love.graphics.setColor(1, 1, 1, 1)
...
function Draw.drawHPAndLevel(unit, panelX, padding, nameY)
...
function Draw.drawAnimation(unit, panelX, padding, nameY)
...
function Draw.drawStats(unit, panelX, padding, nameY, statsY)
...
function Draw.drawUnit(unit, screenW)
    ...
    Draw.drawAvatar(unit, panelX, panelY, padding)

    local nameY = panelY + padding + Config.NAME_Y_OFFSET
    Draw.drawNameAndType(unit, panelX, panelY, padding, nameY)
    Draw.drawHPAndLevel(unit, panelX, padding, nameY)
    Draw.drawAnimation(unit, panelX, padding, nameY)

    local statsY = nameY + Config.STATS_Y_BASE_OFFSET
    Draw.drawStats(unit, panelX, padding, nameY, statsY)
end
